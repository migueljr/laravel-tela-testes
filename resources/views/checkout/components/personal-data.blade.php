    ...
    <div id="personal-data" class="rounded bg-white" style="padding:20px;">
        <div class="flex flex-col" style="gap:5px;">
            <div class="flex items-center" style="gap:5px;">
                <svg style="color:#666666;min-width:35px;height:35px;" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
@push('styles')
    <style>
        ...
        {
            #personal-data{margin-top:15px;width:85%;}
